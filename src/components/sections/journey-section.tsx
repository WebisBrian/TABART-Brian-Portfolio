                ...
                {journeySteps.map((step) => {
                  ...
                  return (
                    <TabsTrigger
                      ...
                      className="flex-1 cursor-pointer inline-flex items-center justify-center gap-2 rounded-full border border-border px-4 py-2 text-sm text-muted-foreground transition-colors hover:bg-foreground/8 hover:text-foreground data-[state=active]:!bg-primary data-[state=active]:!border-primary data-[state=active]:!text-primary-foreground data-[state=active]:!font-medium data-[state=active]:!shadow-none data-active:!bg-primary data-active:!border-primary data-active:!text-primary-foreground sm:flex-none"
                    >
